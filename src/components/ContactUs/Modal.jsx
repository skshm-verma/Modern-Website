...
const Modal = ({ open, setOpen }) => {
  ...
  return (
    <div>
      <motion.div
        className="sm:right-0 sm:bottom-0 sm:justify-center sm:ml-5 bg-white fixed right-4 bottom-2 z-20 flex flex-col rounded-2xl"
      ...
      >
        ...
        >
          <h5 className="cursor-pointer text-4xl text-blue-500 font-inter font-medium tracking-tight pt-4">
            Hello There 🖐🏻
            {/* short hand comand to get emoji is = windows key + dot(.) */}
          </h5>
